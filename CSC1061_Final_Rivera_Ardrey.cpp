...
26 November 2023 4:30 - Mark Ardrey
  Finished function overload of inn.
  Removed function blacksmith.
 ****************************************************************/
...
void arenas::inn(bool knownForest)
{
  ...
  bool finished; //finished is to be replaced with whatever is used to track
  ...
  if (knownForest == false)
    ...
    {
      cout << "\nWhen you walk into the inn, you find it bustling with business."
           << "\nHowever, you can still spot the bartender and the wounded soldier.";
      while (answer != 4)
        {
          cout << "\n\n1 to talk with the bartender."
               << "\n2 to talk with the wounded soldier."
          ...
          if (answer == 1)
            {
              cout << "\nAs you walk up to the bartender, he is still polishing shot glasses.";
              while (answer == 1)
                {
                  cout << "\n\n[Bartender]: Welcome back, " << playerEdit.name << ". What can I get you to drink?"
                       << "\n1 to get a health potion. (10 gold)"
                       << "\n2 to finish talking."
                       << "\nEnter answer: ";
                  cin >> answer;
                  ...
                  if (answer == 1)
                    {
                      if (playerEdit.gold >= 10)
                        {
                          cout << "\n[Bartender]: Ah, some of my finest work. This ought to heal you right up.";
                          playerEdit.healthPotions++;
                          playerEdit.gold -= 10;
                        }
                      else
                        {
                          cout << "\n[Bartender]: I am sorry, it appears you cannot afford this.\n[Bartender]: Come back when you've got a bit more coin.";
                        }
                    }
                  else if (answer = 2)
                    {
                      cout << "\n[Bartender]: It's been nice talking with you again.";
                    }
                  else
                    {
                      cout << "\n[Bartender]: I don't understand what you're saying.";
                    }
                }
            }
            ...
            {
              cout << "\nThe wounded soldier is still in his same chair, wincing with pain as he tries to adjust his leg.";

              /*
              //the wolf is the first target
              if (playerEdit.getLevel() == 1)
                {
                  if (playerEdit.finished() == true) //finished is to be replaced with whatever will be used to tell if the quest is done
                    {
                      cout << "\n\n[Wounded Soldier]: Well done, here is your payment of 50 gold."
                           << "\n[Wounded Soldier]: I have a new quest for you. There is apparently a new goblin lord roaming the forest. I ask of you to dispose of him.";
                      playerEdit.levelUp();
                      playerEdit.gold += 50;
                    }
                  else if (playerEdit.finished() == false)
                    {
                      cout << "\n[Wounded Soldier]: It appears you still have not defeated the wolf terrorizing the locals. Report back to me when you have defeated the wolf.";
                    }
                }

              //the goblin boss is the second target
              if (playerEdit.getLevel() == 2)
                {
                  if (playerEdit.finished() == true)
                    {
                      cout << "\n\n[Wounded Soldier]: Well done, here is your payment of 50 gold."
                           << "\n[Wounded Soldier]: I have a new target for you. A dragon has made its nest in the forest. I ask of you to dispose of him, before the town is cooked to a crisp.";
                      playerEdit.levelUp();
                      playerEdit.gold += 50;
                    }
                  else if (playerEdit.finished() == false)
                    {
                      cout << "\n[Wounded Soldier]: It appears you still have not defeated the goblin lord. Report back to me when you have deposed him.";
                    }
                }

              //the dragon is the third target
              if (playerEdit.getLevel() == 3)
                {
                  if (playerEdit.finished() == true)
                    {
                      cout << "\n\n[Wounded Soldier]: Well done, here is your payment of 100 gold."
                           << "\n[Wounded Soldier]: Thanks to you, the town is now mostly safe from the monsters of the forest. Thank you, deeply.";
                      playerEdit.levelUp();
                      playerEdit.gold += 50;
                    }
                  else if (playerEdit.finished == false)
                    {
                      cout << "\n[Wounded Soldier]: It appears you still have not defeated the dragon nesting nearby. Report back to me when you kill him.";
                    }
                    }*/
            }
              ...
              while (answer != 2)
                {
                  ...
                  if (answer == 1)
                    {
                      cout << "\nAfter a sleep in the confortable bed, you find yourself rejuvinated.";
                      playerEdit.setHealth(playerEdit.getMaxHealth());
                    }

                  else if (answer == 2)
                    {
                      cout << "\nAs you head back down into the bar, there is a large crowd playing games, singing songs, and being merry."
                           << "\nHowever, you can still spot the bartender and the wounded soldier.";
                    }
                }
            }
